...
void createDebugLogFile(const QString file_name)
{
    ...
    QStringList existingFiles = dir.entryList(QStringList() << "DebugLog*", QDir::Files);
...
void setUpLogging()
{
    ...
    session_log_file = log_folder.filePath("SessionLog-" + QDateTime::currentDateTime().toString("yyyy-MM-dd_hh-mm-ss") + ".log");
    createSessionLogFile(session_log_file);

    debug_log_file = log_folder.filePath("DebugLog-" + QDateTime::currentDateTime().toString("yyyy-MM-dd_hh-mm-ss") + ".log");
...
void messageHandler(QtMsgType type, const QMessageLogContext& context, const QString& msg)
{
    ...
    //    break;
    //case QtCriticalMsg:
    //    textStream << "Critical: " << msg << "\n";
    //    break;
    //case QtFatalMsg:
    //    textStream << "Fatal: " << msg << "\n";
    //    abort();
    //}
}